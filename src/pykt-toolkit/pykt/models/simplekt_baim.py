...
class SimpleKTBAIMInteractionEmbedder(nn.Module):
    ...
    def __init__(
        ...
        debug_print(
            f"SimpleKTBAIMInteractionEmbedder initialized.",
            fuc_name=model_name,
        )
...
class SimpleKTBAIMNet(nn.Module):
    def __init__(
        self,
        n_question,
        n_pid,
        ...
        self.polya_emb = SimpleKTBAIMInteractionEmbedder(
            n_question,
            raw_emb_size,
            d_model,
            dropout,
...
class SimpleKTBAIM(QueBaseModel):
    def __init__(
        self,
        n_question,
        n_pid,
        ...
        **kwargs,
        ...
        debug_print(
            f"Initializing SimpleKTBAIM (State-Aware MoE + SimpleKT + Balancing)...",
            fuc_name=model_name,
        )

        self.model = SimpleKTBAIMNet(
            n_question=n_question,
            n_pid=n_pid,
            d_model=d_model,
            n_blocks=n_blocks,
...
class Architecture(nn.Module):
    def __init__(
        ...
        # Using SimpleKT_que's block structure
