...
"""
Polya-SimpleKT V5 Training Script (State-Aware MoE + SimpleKT)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="polya_simplekt_v5")
    parser.add_argument("--emb_type", type=str, default="qid")
    parser.add_argument("--save_dir", type=str, default="saved_model_polya_simplekt_v5")
    ...
    parser.add_argument("--learning_rate", type=float, default=1e-3) # [변경] 1e-4 -> 1e-3
    ...
    parser.add_argument("--n_blocks", type=int, default=2, help="Number of transformer blocks") # [변경] 1 -> 2
    parser.add_argument("--num_attn_heads", type=int, default=4, help="Number of attention heads") # [변경] 8 -> 4
