...
"""
SparseKT-BAIM Training Script (State-Aware MoE + SparseKT)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="sparsekt_baim")
    # 주의: Sparse Attention을 쓰려면 'qid' 대신 'qid_sparseattn'을 써야 함
    parser.add_argument("--emb_type", type=str, default="qid_sparseattn")
    parser.add_argument("--save_dir", type=str, default="saved_model_sparsekt_baim")
